...
익명함수가 실제로 널리 사용되는 부분은 [`map` 함수에서의 익명함수의 사용](04_containers.qmd#sec-anonymous_function_in_map) 에서 볼 수 있듯이 `map`, `reduce`, 등에서 유용하게 사용됩니다. 또한 [`배열 comprehension`](06_arrays.qmd#sec-array_comprehension) 에서도 널리 사용됩니다. 
