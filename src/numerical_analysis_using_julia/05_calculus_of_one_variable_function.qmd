...
함수 $f(x)$ 를 $[x_i,\, x_{i+1}]$ 구간에서 1차 다항식으로 근사하는 것을 **사다리꼴 방법** 이라고 하며, 주어진 점으로부터 다항식을 구하는 방법은 [다항식을 이용한 전역적 보간법](04_interpolation.qmd#sec-global_interpolation_using_polynomial) 에서 설명한 세가지 방법중 한가지를 사용한다.
